"""converted all ids execpt user id

Revision ID: fcca4c1c3fb6
Revises: 
Create Date: 2025-10-16 21:30:00.210231
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('workbook_id', 'question_no', 'page_no')
    )
    ...
    sa.ForeignKeyConstraint(['workbook_id'], ['student_workbook.workbook_id'], ),
    sa.PrimaryKeyConstraint('workbook_id', 'question_no')
    )
